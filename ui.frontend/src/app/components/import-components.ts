 ...
 */
MapTo('sampleangularspa/components/navigation')(NavigationV1Component, {isEmpty: NavigationV1IsEmptyFn});
MapTo('sampleangularspa/components/separator')(SeparatorV1Component);

MapTo('sampleangularspa/components/container')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});
MapTo('sampleangularspa/components/experiencefragment')(ContainerV1Component, {isEmpty: ContainerIsEmptyFn});

MapTo('sampleangularspa/components/download')(DownloadV1Component,{isEmpty: DownloadV1IsEmptyFn});
MapTo('sampleangularspa/components/languagenavigation')(LanguageNavigationV1Component);
MapTo('sampleangularspa/components/list')(ListV2Component, {isEmpty: ListV2IsEmptyFn});
MapTo('sampleangularspa/components/breadcrumb')(BreadCrumbV2Component, {isEmpty: BreadCrumbV2IsEmptyFn});
MapTo('sampleangularspa/components/button')(ButtonV1Component, {isEmpty: ButtonV1IsEmptyFn});
MapTo('sampleangularspa/components/image')(ImageV2Component, {isEmpty: ImageV2IsEmptyFn});
MapTo('sampleangularspa/components/title')(TitleV2Component, {isEmpty: TitleV2IsEmptyFn});

MapTo('sampleangularspa/components/accordion')(AccordionV1Component);
MapTo('sampleangularspa/components/tabs')(TabsV1Component);
...
LazyMapTo('sampleangularspa/components/teaser')(TeaserV1Component);
...
LazyMapTo('sampleangularspa/components/carousel')(CarouselV1Component);
...
LazyMapTo('sampleangularspa/components/text')(LazyTextModule, TextEditConfig);